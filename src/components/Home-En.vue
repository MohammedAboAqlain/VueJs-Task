  ...
  <div>
    ...
    <div id="nav">
      <b-navbar toggleable="xs" type="dark" variant="info">
        ...
        <div class="row no-gutters position-absolute" style="left: 7%">
    ...
    <div id="firebase-content" class="container my-5" dir="ltr">
      <div class="row">
        ...
        <div class="col-md-6 col-lg-8">
          <div class="row">
            <div v-for="img in images" :key="img" class="col-md-6">
              <img :src="require('../assets/images/' + img.imgSrc)" alt="image not loaded" class="w-100" />
...
import AboutUs from './AboutUs-En.vue'
...
export default {
  ...
  methods: {
    ...
    changeLanguage(){
        this.$emit('languageChanged', 'app-home');
    }
  },
  components: {
    appSlider: Slider,
